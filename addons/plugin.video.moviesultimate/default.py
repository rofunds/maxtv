# -*- coding: utf-8 -*-
#------------------------------------------------------------
# MoviesUltimate - Addon por Team Ultimate
...
__home__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.moviesultimate/', ''))
...
__art__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.moviesultimate/art', ''))
__cbx_pages__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.moviesultimate/art/cbx', ''))
__icons__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.moviesultimate/art/icons', ''))
__libdir__ = xbmc.translatePath(os.path.join('special://xbmc/system/players/dvdplayer/', ''))
__tools__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.moviesultimate/resources/tools', ''))
__addons__ = xbmc.translatePath(os.path.join('special://home/addons/', ''))
__resources__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.moviesultimate/resources', ''))
...
def main_list(params):
    ...
    try:
        ...
        mastermenu = 'http://ftatesters.org/addon/master.xml'
        data = plugintools.read(mastermenu)
