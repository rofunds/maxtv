...
class PrimeWire(MovieIndexer, MovieSource, TVShowIndexer, TVShowSource, CustomSettings):
    ...
    base_url = 'https://www.primewire.org/'
    ...
    def __init__(self):
        ...
        xml += '<setting id="custom_url" type="labelenum" label="URL" default="https://www.primewire.org/" values="Custom|http://www.1channel.ch/|http://www.primewire.org/|http://www.letmewatchthis.ch/|http://www.primewires.org/" />\n'
        xml += '<setting id="custom_text_url" type="text" label="     Custom" default="http://www.primewires.org/" enable="eq(-1,0)" />\n'
    ...
    def GetFileHostsForContent(self, title, name, year, season, episode, type, list, lock, message_queue): 
        ...
        if custom_url=='http://primewire.unblocked.pw/':
            ...
            ADDON.setSetting('custom_text_url','https://primewire.org/')     
        ...
        if 'virginmedia.com/courtorders' in search_page_content.lower() or 'ukispcourtorders' in search_page_content.lower() or 'is not available through bskyb' in search_page_content.lower() or 'ACCESS TO THE WEBSITES LISTED ON THIS PAGE HAS BEEN BLOCKED PURSUANT TO ORDERS OF THE HIGH COURT' in search_page_content.upper():
            ...
            ADDON.setSetting('custom_text_url','http://www.primewires.org/')        
