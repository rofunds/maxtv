...
if username.replace('%20',' ') in welcometext:
    ...
    dialog.ok('There is a problem with your login details', 'Please make sure you entered your [COLOR=yellow]username[/COLOR].', 'An email address and a username is NOT the same thing.', '[CR]Remember both username and password ARE case sensitive.')
